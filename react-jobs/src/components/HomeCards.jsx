...
const HomeCards = () => {
  return (
    <div className='max-w-5xl flex flex-col sm:flex-row items-center justify-center w-full mx-3 md:mx-auto gap-4 sm:gap-2 mt-7 mb-5'>
      <section className='border-2 bg-gray-100 p-4 rounded-lg shadow-md min-w-[40vw]'>
          <h2 className='font-bold text-2xl'>
            For Developers
          </h2>
          <p className='mt-2 mb-4'>Browse our React jobs and start your career today</p>
          <button type="submit" className='border-1 bg-black rounded-lg px-4 py-2 text-white hover:bg-gray-700'>
            Browse jobs
          </button>
      </section>
