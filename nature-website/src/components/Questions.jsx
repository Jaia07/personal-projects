...
const Questions = () => {
    ...
    return (
        <section className="bg-center bg-cover min-h-[55vh] w-full flex justify-center items-center gap-4 mb-3 mt-10"
        ...
        >
            <div className="max-w-[550px] w-full m-auto text-center">
                ...
                <button type="submit" className="border-0 outline-none bg-[#ffd936] rounded-md py-3 px-5 font-Forum font-bold">Let's Talk Now</button>
            </div>
        </section>
    )
}
